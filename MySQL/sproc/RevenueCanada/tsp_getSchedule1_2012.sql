IF OBJECT_ID('dbo.tsp_getSchedule1_2012') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.tsp_getSchedule1_2012
    IF OBJECT_ID('dbo.tsp_getSchedule1_2012') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.tsp_getSchedule1_2012 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.tsp_getSchedule1_2012 >>>'
END
go
CREATE PROCEDURE dbo.tsp_getSchedule1_2012
     @col260  numeric(12,2), 
...
BEGIN
     ...
     SELECT @col315= 2 * 4402 -- caregiver amount schedule 5 changjiu only for now; kairong tax year 2011
...
go
GRANT EXECUTE ON dbo.tsp_getSchedule1_2012 TO web
go
IF OBJECT_ID('dbo.tsp_getSchedule1_2012') IS NOT NULL
   PRINT '<<< CREATED PROCEDURE dbo.tsp_getSchedule1_2012 >>>'
ELSE
   PRINT '<<< FAILED CREATING PROCEDURE dbo.tsp_getSchedule1_2012 >>>'
go
EXEC sp_procxmode 'dbo.tsp_getSchedule1_2012','unchained'
go
