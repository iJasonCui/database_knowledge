IF OBJECT_ID('dbo.tsp_getON428_2012') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.tsp_getON428_2012
    IF OBJECT_ID('dbo.tsp_getON428_2012') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.tsp_getON428_2012 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.tsp_getON428_2012 >>>'
END
go
CREATE PROCEDURE tsp_getON428_2012
     @col260  numeric(12,2), 
...
go
GRANT EXECUTE ON dbo.tsp_getON428_2012 TO web
go
IF OBJECT_ID('dbo.tsp_getON428_2012') IS NOT NULL
   PRINT '<<< CREATED PROCEDURE dbo.tsp_getON428_2012 >>>'
ELSE
   PRINT '<<< FAILED CREATING PROCEDURE dbo.tsp_getON428_2012 >>>'
go
EXEC sp_procxmode 'dbo.tsp_getON428_2012','unchained'
go
