...
#
#
# rec_index.pl	A script to extract an index recreate structure from
#		a Sybase database
#
# Last Mods:    07 November 2001
#
# Usage:	rec_index.pl -d database -o script.name -t pattern -s server -v -T endtime
...
my $sth;
my ($rule, $dflt, $date, $name, $cnt2, $flg1);


select (STDOUT); $| = 1;		# make unbuffered

getopts ('u:p:d:t:o:s:i:v:T:');
...
$Getopt::Std::opt_T = 'Jan 1 2999' unless $Getopt::Std::opt_T; 

#print "$Getopt::Std::opt_T\n";
...
print "\nrec_index.pl on Database $Getopt::Std::opt_s.$Getopt::Std::opt_d\n";
...
print SCRIPT
    "/* This Isql script was generated by rec_index.pl on $date.  */\n";


print SCRIPT "\nuse $Getopt::Std::opt_d\ngo\n"; # Change to the appropriate database


print "Generating script for table $Getopt::Std::opt_t...";
print "\n" if $Getopt::Std::opt_v;
...
#print SCRIPT "\nPRINT '<<<<<<     @$tabref[1].@$tabref[0]     >>>>>> '\n\go\n";

#print SCRIPT "\nsp_configure 'allow updates' , 1\n\go\n" ;

#print SCRIPT "\nDELETE systabstats WHERE id = object_id ('@$tabref[1].@$tabref[0]')\n\go\n";

#print SCRIPT "\nDELETE sysstatistics WHERE id = object_id ('@$tabref[1].@$tabref[0]')\n\go\n";

#print SCRIPT "\nsp_configure 'allow updates' , 0\n\go\n" ;

#print SCRIPT "\nUPDATE STATISTICS @$tabref[0]\n\go\n" ;
    
    $sth = $dbh->prepare (<<SQLEND
select name, indid, status, status2,
    key1 = index_col ('@$tabref[1].@$tabref[0]', indid, 1) + ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 1),
    key2 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 2) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 2)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 2) 
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 2) end ,
    key3 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 3) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 3)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 3)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 3) end ,
    key4 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 4) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 4)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 4)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 4) end ,
    key5 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 5) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 5)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 5)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 5) end ,
    key6 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 6) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 6)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 6)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 6) end ,
    key7 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 7) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 7)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 7)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 7) end ,
    key8 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 8) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 8)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 8)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 8) end ,
    key9 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 9) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 9)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 9)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 9) end ,
    key10 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 10) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 10)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 10)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 10) end ,
    key11 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 11) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 11)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 11)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 11) end ,
    key12 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 12) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 12)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 12)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 12) end ,
    key13 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 13) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 13)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 13)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 13) end ,
    key14 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 14) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 14)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 14)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 14) end ,
    key15 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 15) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 15)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 15)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 15) end ,
    key16 = case when (index_col ('@$tabref[1].@$tabref[0]', indid, 16) + ' '
+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 16)) =  ' ' then Null else index_col ('@$tabref[1].@$tabref[0]', indid, 16)
+ ' '+ index_colorder ('@$tabref[1].@$tabref[0]', indid, 16) end 
from dbo.sysindexes
where id = object_id ('@$tabref[1].@$tabref[0]')
and indid between 1 and 254
order by status2 desc , indid asc
SQLEND
);
    $sth->execute;
...
# otherwise buffer it up to print as an index afterwards
	...
	if ($field[3] & 2) {
#	    print (SCRIPT ",\n\t");
            print "\nGenerating Primary key constraint : @$tabref[1].@$tabref[0].$field[0] ";
            print SCRIPT "\ndeclare \@getdate datetime\nselect \@getdate=getdate()\n" ;
#            print SCRIPT "\nselect 'Begin time for @$tabref[1].@$tabref[0].$field[0] is ' + convert(char(20),getdate() )\ngo\n";
            print SCRIPT "ALTER TABLE @$tabref[1].@$tabref[0] DROP\n";
#           print SCRIPT "CONSTRAINT $field[0]\ngo\n" unless ($field[3] & 8);
            print SCRIPT "CONSTRAINT $field[0]\n";

            print SCRIPT "\nIF NOT EXISTS (SELECT * FROM sysindexes WHERE id=OBJECT_ID('@$tabref[1].@$tabref[0]') AND name='$field[0]')\nPRINT '<<<<<< %1! Constraint @$tabref[1].@$tabref[0].$field[0] Drop SUCCEEDED!!! >>>>>>',\@getdate\n";
            print SCRIPT "ELSE\nPRINT '<<<<<<< %1! Constraint @$tabref[1].@$tabref[0].$field[0] Drop FAILED!!! >>>>>>>',\@getdate\n\go\n";

            print SCRIPT "ALTER TABLE @$tabref[1].@$tabref[0] ADD\n";
#	    print SCRIPT "CONSTRAINT $field[0] " unless ($field[3] & 8);
            print SCRIPT "CONSTRAINT $field[0] " ;

	    if ($field[2] & 2048) {
		print SCRIPT "PRIMARY KEY ";
		print SCRIPT "NONCLUSTERED " if (($field[1] != 1) && ($field[3] != 512));
	    } else {
		print SCRIPT "UNIQUE ";
		print SCRIPT "CLUSTERED " if (($field[1] == 1) || ($field[3] == 512));
	    }
	    print SCRIPT "(";
	    ...
	    print SCRIPT ")";
            print SCRIPT "\n";
            print SCRIPT "\ndeclare \@getdate datetime\nselect \@getdate=getdate()\n" ;
#            print SCRIPT "\nselect 'End time for @$tabref[1].@$tabref[0].$field[0] is ' + convert(char(20),getdate() )\ngo\n";
            print SCRIPT "\nIF EXISTS (SELECT * FROM sysindexes WHERE id=OBJECT_ID('@$tabref[1].@$tabref[0]') AND name='$field[0]')\nPRINT '<<<<<< %1! Constraint @$tabref[1].@$tabref[0].$field[0] Creation SUCCEEDED!!! >>>>>>',\@getdate\n";
            print SCRIPT "ELSE\nPRINT '<<<<<<< %1! Constraint @$tabref[1].@$tabref[0].$field[0] Creation FAILED!!! >>>>>>>',\@getdate\n\go\n";
            if ( $field[1] == 1 || $field[3] == 512 ) {
                $flg1 = 1 ;
            }
	} else {
	    push @col, [ @field ];
...
#    print SCRIPT "\n)\ngo\n";	# end of CREATE TABLE
	...
	if    ( $flg1 == 1 ) {
        ...
        print SCRIPT "declare \@getdate datetime\nselect \@getdate=getdate()\n" ;
#	print SCRIPT "\nselect 'Begin time for @$tabref[1].@$tabref[0].$field[0] is ' + convert(char(20),getdate() )\ngo\n";	
	print SCRIPT "\nDROP INDEX @$tabref[0].$field[0]\n";
#	print SCRIPT "go\n";

        print SCRIPT "\nIF NOT EXISTS (SELECT * FROM sysindexes WHERE id=OBJECT_ID('@$tabref[1].@$tabref[0]') AND name='$field[0]')\nPRINT '<<<<<< %1! Index @$tabref[1].@$tabref[0].$field[0] Drop SUCCEEDED!!! >>>>>>',\@getdate\n";
        print SCRIPT "ELSE\nPRINT '<<<<<<< %1! Index @$tabref[1].@$tabref[0].$field[0] Drop FAILED!!! >>>>>>>',\@getdate\n\go\n" ;
...
#        print SCRIPT "\ngo\n";
#	print SCRIPT "\nselect 'End time for @$tabref[1].@$tabref[0].$field[0] is ' + convert(char(20),getdate() )\ngo\n";
	print SCRIPT "\nIF EXISTS (SELECT * FROM sysindexes WHERE id=OBJECT_ID('@$tabref[1].@$tabref[0]') AND name='$field[0]')\nPRINT '<<<<<< %1! Index @$tabref[1].@$tabref[0].$field[0] Creation SUCCEEDED!!! >>>>>>',\@getdate\n";
	print SCRIPT "ELSE\nPRINT '<<<<<<< %1! Index @$tabref[1].@$tabref[0].$field[0] Creation FAILED!!! >>>>>>>',\@getdate\n\go\n";
	if  ($field[1] == 1 || $field[3] == 512 ) { 
				print "\nGenerating Clustered index : @$tabref[1].@$tabref[0].$field[0] ";
#				print "\nLooks like I'm all done!!!\n";
				return;
			   }

	print "\nGenerating Non-Clustered index : @$tabref[1].@$tabref[0].$field[0] ";
