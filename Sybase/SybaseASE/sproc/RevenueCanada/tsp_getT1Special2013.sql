IF OBJECT_ID('dbo.tsp_getT1Special2013') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.tsp_getT1Special2013
    IF OBJECT_ID('dbo.tsp_getT1Special2013') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.tsp_getT1Special2013 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.tsp_getT1Special2013 >>>'
END
go
CREATE PROCEDURE tsp_getT1Special2013
     ...
     @EI  numeric(12,2),  --891.12
     @Donation  numeric(12,2),  --75.00
     @childrenAmount  numeric(12,2), --children amount; Line 5, col367; 2 * $2234 = $4468
...
BEGIN
     ...
     DECLARE @line479  numeric(12,2) --ONTARIO CREDITS
     ...
     SELECT @line233 = @RRSP_line208 + @INTREST_EXPENSE_line221
     ...
     EXEC tsp_getSchedule1_2013 @line260, @spouseNetIncome, @combineFlag, @CPP, @EI, @Donation, @childrenAmount, @line420 output, @col345 output, @col347 output
     PRINT "Line 420: %1! " , @line420
     
      PRINT "#-----------------------------------------#" 
      PRINT "Go to Ontario Tax 428"
      --ontario tax 428
      EXEC tsp_getON428_2013 @line260,   @spouseNetIncome,   @combineFlag , @CPP, @EI, @col345, @col347, @line428 output 
      ...
      PRINT "Line 437: %1! " , @TAX_DEDUCTED_line437
      
      SELECT @line479  = 105.2
      PRINT "Line 479: %1! " , @line479
            
      SELECT @line482 = @TAX_DEDUCTED_line437 + @line479
...
go
GRANT EXECUTE ON dbo.tsp_getT1Special2013 TO web
go
IF OBJECT_ID('dbo.tsp_getT1Special2013') IS NOT NULL
   PRINT '<<< CREATED PROCEDURE dbo.tsp_getT1Special2013 >>>'
ELSE
   PRINT '<<< FAILED CREATING PROCEDURE dbo.tsp_getT1Special2013 >>>'
go
EXEC sp_procxmode 'dbo.tsp_getT1Special2013','unchained'
go
