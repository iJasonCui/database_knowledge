IF OBJECT_ID('dbo.tsp_getON428_2011') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.tsp_getON428_2011
    IF OBJECT_ID('dbo.tsp_getON428_2011') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.tsp_getON428_2011 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.tsp_getON428_2011 >>>'
END
go
CREATE PROCEDURE tsp_getON428_2011
     @col260  numeric(12,2), 
...
BEGIN
     ...
     SELECT @col5804= 9104
     SELECT @col5804_1= 8503
     SELECT @col5840= 2 * 4291
     ...
     BEGIN
          ...
          IF @col5812 >= 7730 SELECT @col5812 = 7730
     END
     ELSE BEGIN
          SELECT @col5812 = 0
     END
     ...
     IF @col260 <= 37774                       SELECT @LINE36 = convert(numeric(12,2), @col260 * 0.0505)
     IF @col260 >  37774 AND @col260 <= 75550  SELECT @LINE36 = convert(numeric(12,2), 1908 + (@col260 - 37774) * 0.0915)
     IF @col260 >  75550                       
     BEGIN
     ...
     --ontario surtax
     SELECT @line50  = convert(numeric(12,2), (@line49 - 4078) *0.2 )
     IF  @line50  < 0  SELECT @line50  =  0
     PRINT "Line 50 %1! " , @line50
      
     DECLARE @line51 numeric(12,2)
     SELECT @line51  = convert(numeric(12,2), (@line49 - 5219) *0.36 )
...
go
GRANT EXECUTE ON dbo.tsp_getON428_2011 TO web
go
IF OBJECT_ID('dbo.tsp_getON428_2011') IS NOT NULL
   PRINT '<<< CREATED PROCEDURE dbo.tsp_getON428_2011 >>>'
ELSE
   PRINT '<<< FAILED CREATING PROCEDURE dbo.tsp_getON428_2011 >>>'
go
EXEC sp_procxmode 'dbo.tsp_getON428_2011','unchained'
go
