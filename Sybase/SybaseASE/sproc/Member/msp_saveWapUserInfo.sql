IF OBJECT_ID('dbo.msp_saveWapUserInfo') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.msp_saveWapUserInfo
    IF OBJECT_ID('dbo.msp_saveWapUserInfo') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.msp_saveWapUserInfo >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.msp_saveWapUserInfo >>>'
END
go
 /***********************************************************************
**
...
CREATE PROCEDURE msp_saveWapUserInfo
...
go
GRANT EXECUTE ON dbo.msp_saveWapUserInfo TO web
go
IF OBJECT_ID('dbo.msp_saveWapUserInfo') IS NOT NULL
   PRINT '<<< CREATED PROCEDURE dbo.msp_saveWapUserInfo >>>'
ELSE
   PRINT '<<< FAILED CREATING PROCEDURE dbo.msp_saveWapUserInfo >>>'
go
EXEC sp_procxmode 'dbo.msp_saveWapUserInfo','unchained'
go
