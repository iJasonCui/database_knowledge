IF OBJECT_ID('dbo.wssp_cntMemberNew') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wssp_cntMemberNew
    IF OBJECT_ID('dbo.wssp_cntMemberNew') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wssp_cntMemberNew >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wssp_cntMemberNew >>>'
END
go
/******************************************************************************
**
...
**
******************************************************************************/
CREATE PROCEDURE wssp_cntMemberNew
@productCode char(1)
...
go
EXEC sp_procxmode 'dbo.wssp_cntMemberNew','unchained'
go
IF OBJECT_ID('dbo.wssp_cntMemberNew') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.wssp_cntMemberNew >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.wssp_cntMemberNew >>>'
go
GRANT EXECUTE ON dbo.wssp_cntMemberNew TO web
go
