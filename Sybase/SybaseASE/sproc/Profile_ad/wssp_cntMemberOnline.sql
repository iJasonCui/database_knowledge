IF OBJECT_ID('dbo.wssp_cntMemberOnline') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wssp_cntMemberOnline
    IF OBJECT_ID('dbo.wssp_cntMemberOnline') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wssp_cntMemberOnline >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wssp_cntMemberOnline >>>'
END
go
/******************************************************************************
**
...
**
******************************************************************************/
CREATE PROCEDURE  wssp_cntMemberOnline
@productCode char(1),
...
EXEC sp_procxmode 'dbo.wssp_cntMemberOnline','unchained'
go
IF OBJECT_ID('dbo.wssp_cntMemberOnline') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.wssp_cntMemberOnline >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.wssp_cntMemberOnline >>>'
go
GRANT EXECUTE ON dbo.wssp_cntMemberOnline TO web
go
