IF OBJECT_ID('dbo.wsp_getMembSearchLocalP') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wsp_getMembSearchLocalP
    IF OBJECT_ID('dbo.wsp_getMembSearchLocalP') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wsp_getMembSearchLocalP >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wsp_getMembSearchLocalP >>>'
END
go
/******************************************************************************
**
...
**
****************************************************************************/
CREATE PROCEDURE  wsp_getMembSearchLocalP
 @productCode CHAR(1)
...
go
GRANT EXECUTE ON dbo.wsp_getMembSearchLocalP TO web
go
IF OBJECT_ID('dbo.wsp_getMembSearchLocalP') IS NOT NULL
   PRINT '<<< CREATED PROCEDURE dbo.wsp_getMembSearchLocalP >>>'
ELSE
   PRINT '<<< FAILED CREATING PROCEDURE dbo.wsp_getMembSearchLocalP >>>'
go
EXEC sp_procxmode 'dbo.wsp_getMembSearchLocalP','unchained'
go
