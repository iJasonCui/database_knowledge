IF OBJECT_ID('dbo.wsp_getMembLocalNew') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wsp_getMembLocalNew
    IF OBJECT_ID('dbo.wsp_getMembLocalNew') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wsp_getMembLocalNew >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wsp_getMembLocalNew >>>'
END
go
/******************************************************************************
**
...
**
******************************************************************************/
CREATE PROCEDURE wsp_getMembLocalNew
@productCode char(1)
...
go
GRANT EXECUTE ON dbo.wsp_getMembLocalNew TO web
go
IF OBJECT_ID('dbo.wsp_getMembLocalNew') IS NOT NULL
   PRINT '<<< CREATED PROCEDURE dbo.wsp_getMembLocalNew >>>'
ELSE
   PRINT '<<< FAILED CREATING PROCEDURE dbo.wsp_getMembLocalNew >>>'
go
EXEC sp_procxmode 'dbo.wsp_getMembLocalNew','unchained'
go
