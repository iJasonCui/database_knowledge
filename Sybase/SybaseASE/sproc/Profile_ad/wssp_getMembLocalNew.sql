IF OBJECT_ID('dbo.wssp_getMembLocalNew') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wssp_getMembLocalNew
    IF OBJECT_ID('dbo.wssp_getMembLocalNew') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wssp_getMembLocalNew >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wssp_getMembLocalNew >>>'
END
go
/******************************************************************************
**
...
**
******************************************************************************/
CREATE PROCEDURE wssp_getMembLocalNew
@productCode char(1)
...
go
EXEC sp_procxmode 'dbo.wssp_getMembLocalNew','unchained'
go
IF OBJECT_ID('dbo.wssp_getMembLocalNew') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.wssp_getMembLocalNew >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.wssp_getMembLocalNew >>>'
go
GRANT EXECUTE ON dbo.wssp_getMembLocalNew TO web
go
