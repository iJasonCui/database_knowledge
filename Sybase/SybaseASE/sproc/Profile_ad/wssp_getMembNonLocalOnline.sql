IF OBJECT_ID('dbo.wssp_getMembNonLocalOnline') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wssp_getMembNonLocalOnline
    IF OBJECT_ID('dbo.wssp_getMembNonLocalOnline') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wssp_getMembNonLocalOnline >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wssp_getMembNonLocalOnline >>>'
END
go
/******************************************************************************
**
...
**
******************************************************************************/
CREATE PROCEDURE  wssp_getMembNonLocalOnline
@productCode char(1),
...
EXEC sp_procxmode 'dbo.wssp_getMembNonLocalOnline','unchained'
go
IF OBJECT_ID('dbo.wssp_getMembNonLocalOnline') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.wssp_getMembNonLocalOnline >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.wssp_getMembNonLocalOnline >>>'
go
GRANT EXECUTE ON dbo.wssp_getMembNonLocalOnline TO web
go
