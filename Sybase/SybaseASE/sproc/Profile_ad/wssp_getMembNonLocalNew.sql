IF OBJECT_ID('dbo.wssp_getMembNonLocalNew') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wssp_getMembNonLocalNew
    IF OBJECT_ID('dbo.wssp_getMembNonLocalNew') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wssp_getMembNonLocalNew >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wssp_getMembNonLocalNew >>>'
END
go
/******************************************************************************
**
...
**
******************************************************************************/
CREATE PROCEDURE wssp_getMembNonLocalNew
@productCode char(1)
...
EXEC sp_procxmode 'dbo.wssp_getMembNonLocalNew','unchained'
go
IF OBJECT_ID('dbo.wssp_getMembNonLocalNew') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.wssp_getMembNonLocalNew >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.wssp_getMembNonLocalNew >>>'
go
GRANT EXECUTE ON dbo.wssp_getMembNonLocalNew TO web
go
