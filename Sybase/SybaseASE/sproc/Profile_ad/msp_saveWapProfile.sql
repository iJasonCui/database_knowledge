IF OBJECT_ID('dbo.msp_saveWapProfile') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.msp_saveWapProfile
    IF OBJECT_ID('dbo.msp_saveWapProfile') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.msp_saveWapProfile >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.msp_saveWapProfile >>>'
END
go
 /***********************************************************************
**
...
CREATE PROCEDURE msp_saveWapProfile
@product char(1)
,@community char(1)
,@userId numeric (12,0)
,@username char(16)
...
GRANT EXECUTE ON dbo.msp_saveWapProfile TO web
go

IF OBJECT_ID('dbo.msp_saveWapProfile') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.msp_saveWapProfile >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.msp_saveWapProfile >>>'
go

EXEC sp_procxmode 'dbo.msp_saveWapProfile','unchained'
go
