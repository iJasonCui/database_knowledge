IF OBJECT_ID('dbo.wsp_getMembSearchLocalB') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wsp_getMembSearchLocalB
    IF OBJECT_ID('dbo.wsp_getMembSearchLocalB') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wsp_getMembSearchLocalB >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wsp_getMembSearchLocalB >>>'
END
go
/******************************************************************************
**
...
**
****************************************************************************/
CREATE PROCEDURE  wsp_getMembSearchLocalB
 @productCode CHAR(1)
...
go
GRANT EXECUTE ON dbo.wsp_getMembSearchLocalB TO web
go
IF OBJECT_ID('dbo.wsp_getMembSearchLocalB') IS NOT NULL
   PRINT '<<< CREATED PROCEDURE dbo.wsp_getMembSearchLocalB >>>'
ELSE
   PRINT '<<< FAILED CREATING PROCEDURE dbo.wsp_getMembSearchLocalB >>>'
go
EXEC sp_procxmode 'dbo.wsp_getMembSearchLocalB','unchained'
go
