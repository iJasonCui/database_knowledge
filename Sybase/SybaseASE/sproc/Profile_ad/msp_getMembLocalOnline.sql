...
IF OBJECT_ID('dbo.msp_getMembLocalOnline') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.msp_getMembLocalOnline
    IF OBJECT_ID('dbo.msp_getMembLocalOnline') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.msp_getMembLocalOnline >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.msp_getMembLocalOnline >>>'
END
go
CREATE PROCEDURE  msp_getMembLocalOnline
@productCode char(1),
...
go
EXEC sp_procxmode 'dbo.msp_getMembLocalOnline','unchained'
go
IF OBJECT_ID('dbo.msp_getMembLocalOnline') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.msp_getMembLocalOnline >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.msp_getMembLocalOnline >>>'
go
GRANT EXECUTE ON dbo.msp_getMembLocalOnline TO web
go
