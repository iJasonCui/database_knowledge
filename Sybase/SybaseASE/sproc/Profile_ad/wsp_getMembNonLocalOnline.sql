IF OBJECT_ID('dbo.wsp_getMembNonLocalOnline') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wsp_getMembNonLocalOnline
    IF OBJECT_ID('dbo.wsp_getMembNonLocalOnline') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wsp_getMembNonLocalOnline >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wsp_getMembNonLocalOnline >>>'
END
go
/******************************************************************************
**
...
**
******************************************************************************/
CREATE PROCEDURE  wsp_getMembNonLocalOnline
@productCode char(1),
...
END
go
EXEC sp_procxmode 'dbo.wsp_getMembNonLocalOnline','unchained'
go
IF OBJECT_ID('dbo.wsp_getMembNonLocalOnline') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.wsp_getMembNonLocalOnline >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.wsp_getMembNonLocalOnline >>>'
go
GRANT EXECUTE ON dbo.wsp_getMembNonLocalOnline TO web
go
