IF OBJECT_ID('dbo.wsp_getMembNonLocalVideoVIP') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.wsp_getMembNonLocalVideoVIP
    IF OBJECT_ID('dbo.wsp_getMembNonLocalVideoVIP') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.wsp_getMembNonLocalVideoVIP >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.wsp_getMembNonLocalVideoVIP >>>'
END
go
/******************************************************************************
**
...
**
******************************************************************************/
CREATE PROCEDURE  wsp_getMembNonLocalVideoVIP
@productCode char(1),
...
END
go
EXEC sp_procxmode 'dbo.wsp_getMembNonLocalVideoVIP','unchained'
go
IF OBJECT_ID('dbo.wsp_getMembNonLocalVideoVIP') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.wsp_getMembNonLocalVideoVIP >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.wsp_getMembNonLocalVideoVIP >>>'
go
GRANT EXECUTE ON dbo.wsp_getMembNonLocalVideoVIP TO web
go
