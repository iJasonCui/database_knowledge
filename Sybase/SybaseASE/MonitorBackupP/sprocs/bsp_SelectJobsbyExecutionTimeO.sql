              CREATE PROCEDURE dbo.bsp_SelectJobsbyExecutionTimeO @dateCreatedFrom DATETIME, @dateCreatedTo DATETIME
AS
    BEGIN
    ...
    IF @Tme = convert(datetime,'Jan 1 1900')
     ...
     into #execut
        ...
        J.ownerGroup,J.scriptPath ,U2.name as groupName , E2.dateCreated as maxDateExecuted
          ...
          FROM Job J, Groups BG,sysusers U2 , #execut E1 , Execution E2
          WHERE 
