create replication definition "prad_ProfileMedia"
with primary at LogicalSRV.Profile_ad_prim2
...
create replication definition "prad_TempProfileNameId"
with primary at LogicalSRV.Profile_ad_prim2
...
replicate minimal columns
go
create replication definition "prad_RepTest"
with primary at LogicalSRV.Profile_ad_prim2
...
replicate minimal columns
go
create replication definition "prad_SavedSearch"
with primary at LogicalSRV.Profile_ad_prim2
...
go
create replication definition "prad_a_dating"
with primary at LogicalSRV.Profile_ad_prim2
...
go
create replication definition "prad_a_backgreeting_dating"
with primary at LogicalSRV.Profile_ad_prim2
...
go
create replication definition "prad_a_mompictures_dating"
with primary at LogicalSRV.Profile_ad_prim2
...
replicate minimal columns
go
create replication definition "prad_Blocklist"
with primary at LogicalSRV.Profile_ad_prim2
...
replicate minimal columns
go
create replication definition "prad_Smile"
with primary at LogicalSRV.Profile_ad_prim2
...
replicate minimal columns
go
create replication definition "prad_Hotlist"
with primary at LogicalSRV.Profile_ad_prim2
...
replicate minimal columns
go
create replication definition "prad_Pass"
with primary at LogicalSRV.Profile_ad_prim2
...
replicate minimal columns
go
create replication definition "prad_a_profile_dating"
with primary at LogicalSRV.Profile_ad_prim2
...
create replication definition "prad_SavedSearchTest"
with primary at LogicalSRV.Profile_ad_prim2
