...
use master
go
exec sp_kill_process ${DBName}, x2kivr 
go
...
exec sp_kill_process ${DBName}, x2kimpl       
go

exec sp_kill_process ${DBName}, tomcat      
go

exec sp_kill_process ${DBName}, x2kmaint       
go

exec sp_kill_process ${DBName}, x2kutils     
go
